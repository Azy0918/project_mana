...
VOICE_MANIFEST = REPO_ROOT / "13th-register-kamishibai" / "assets" / "manifest_reading_hiragana_ep09.json"
TIMELINE = REPO_ROOT / "outputs" / "ep09_voice_reading_hiragana" / "ep09_full_voice_reading_hiragana_timeline.json"
DEFAULT_ASSIGNMENT = REPO_ROOT / "ep09_image_assignment_proposal.json"
OUT_PATHS = [
    REPO_ROOT / "13th-register-kamishibai" / "scene_manifest_ep09.json",
    REPO_ROOT / "site" / "scene_manifest_ep09.json",
]

# Claude-owned (台本): visual-cut titles keyed by the IMAGE vc number (Codex's 20 EP09 beats).
TITLE_BY_VC = {
    1: "宇宙っぽいポイント端末", 2: "座木山のカード", 3: "銀河共通ポイント", 4: "残高、八兆ポイント", 5: "地球円に変換しない",
    6: "店が国になる", 7: "宇宙物流の信用残高", 8: "再来店の予告", 9: "唐沢、客単価を見る", 10: "異常値は保留",
    11: "処理候補", 12: "貯めた覚えのないもの", 13: "最終利用、二億年前", 14: "失効処理ですね", 15: "ポイント失効",
    16: "売上、正常範囲", 17: "レシート", 18: "あの会社員が来る", 19: "レシートを探す", 20: "コピー機の予告",
}
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build episode 9 scene manifest from the voice manifest, audio timeline and image assignment."
    )
