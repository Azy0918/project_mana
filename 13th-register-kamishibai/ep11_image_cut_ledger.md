...
| 09 | エリは数えよう | `assets/scenes/planned/ep11_vc09_mina_count_inventory.png` | `ep11_v041-ep11_v045` | エリが棚卸し表を持ち、今あるものを数えようと言う。タクミが驚く。 |
...
| 12 | 現物だけ | `assets/scenes/planned/ep11_vc12_actual_items_only.png` | `ep11_v056-ep11_v060` | エリが現物だけと言い、タクミが実際にあるものだけを数える準備。 |
...
| 15 | 今の店ではこれだけ | `assets/scenes/planned/ep11_vc15_current_store_stamp.png` | `ep11_v071-ep11_v075` | エリが棚卸し表にハンコを押す。今の店ではこれだけ、という確定感。 |
