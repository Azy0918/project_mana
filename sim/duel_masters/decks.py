...
DECKS: dict = {
    ...
    # ===== AD現環境 Tier S(ユーザー提供, 2026-06)。革命チェンジ等を実装してガントレット化 =====
    "AD火闇自然ドギラゴン剣": {   # HBXXYB
        "main": {
            "次元の霊峰": 1, "未来設計図": 4, "爆砕面 ジョニーウォーカー": 4,
            "ウソと盗みのエンターテイナー": 4, "“龍装”チュリス": 4, "龍装者 バルチュリス": 3,
            "絶叫の悪魔龍 イーヴィル・ヒート": 4, "超DXブリキン将軍": 4, "ニルバーナー": 4,
            "蒼き団長 ドギラゴン剣": 4, "撃髄医 スパイナー": 4},
        # 禁断～封印されしX～(禁断の鼓動)はゲーム開始時設置の特殊カードで非対応のため、
        # 革命チェンジ役の超DXブリキン将軍を1枚増やして代替(計40)。
        "super": {},
    },
    "AD火水ドギラゴン剣": {   # HBXZ7Q
        "main": {
            "異端流し オニカマス": 4, "月光電人オボロカゲロウ": 1, "熱湯グレンニャー": 4,
            "プラチナ・ワルスラS": 4, "終末の時計 ザ・クロック": 4, "単騎連射 マグナム": 3,
            "“龍装”チュリス": 4, "龍装者 バルチュリス": 3, "“乱振”舞神 G・W・D": 3,
            "守護炎龍 レヴィヤ・ターン": 4, "蒼き団長 ドギラゴン剣": 4,
            "ゴリガン砕車 ゴルドーザ／ダイナマウス・スクラッパー": 2},
        "super": {},
    },
    "AD水単スコーラー": {
        "main": {
            "セイレーン・コンチェルト": 4, "ガード・グリップ": 4, "時を戻す水時計": 2,
            "泡の魔神・アワンデス": 2, "海郷楽園 パールパーク": 4, "シンクロ・スパイラル": 2,
            "超宮兵 マノミ": 4, "超宮城 コーラリアン": 3, "I am": 2,
            "次元の嵐 スコーラー": 3, "機術士ディール／「本日のラッキーナンバー！」": 2,
            "龍装者 ヴィヌフィース／究めし優美のブレイン": 4,
            "卍 ギ・ルーギリン 卍/卍獄ブレイン": 4},
        "super": {},
    },
    "AD火水レイド": {
        "main": {
            "異端流し オニカマス": 4, "ダチッコ・チュリス": 2, "熱湯グレンニャー": 4,
            "プラチナ・ワルスラS": 4, "終末の時計 ザ・クロック": 3, "ドンドン吸い込むナウ": 3,
            "“必駆”蛮触礼亞": 4, "“轟轟轟”ブランド": 4, "“B-零朱”レイド": 4,
            "勝利龍装 クラッシュ“覇道”": 2, "爆殺!! 覇悪怒楽苦": 3,
            "ゴリガン砕車 ゴルドーザ／ダイナマウス・スクラッパー": 3},
        "super": {},
    },
    "AD火光レイド": {
        "main": {
            "一番隊 クリスタ": 4, "ヘブンズ・フォース": 2, "ダチッコ・チュリス": 1,
            "超次元サプライズ・ホール": 2, "正義の煌き オーリリア": 4, "“必駆”蛮触礼亞": 4,
            "DNA・スパーク": 2, "“轟轟轟”ブランド": 4, "“B-零朱”レイド": 4,
            "閃光の守護者ホーリー": 2, "爆殺!! 覇悪怒楽苦": 3,
            "奇石 ミクセル／ジャミング・チャフ": 4,
            "ゴリガン砕車 ゴルドーザ／ダイナマウス・スクラッパー": 4},
        "super": {"時空の英雄アンタッチャブル": 2, "アクア・カスケード＜ZABUUUN・クルーザー＞": 2,
                  "イオの伝道師ガガ・パックン": 2, "時空の戦猫シンカイヤヌス": 2},
    },
}

# 発掘・較正で使う「現環境メタ」= AD Tier S 5デッキ(NDの旧4デッキはテスト/履歴用に温存)。
META = ["AD火闇自然ドギラゴン剣", "AD火水ドギラゴン剣", "AD水単スコーラー",
        "AD火水レイド", "AD火光レイド"]
