...
| 02 | 人間にレシート | `assets/scenes/planned/ep10_vc02_receipt_for_person.png` | `ep10_v006-ep10_v010` | ミナが本人確認にレシートを使う前提で準備し、タクミが人間に使う言葉ではないと困惑。 |
...
| 10 | ミナがレシート確認 | `assets/scenes/planned/ep10_vc10_mina_receipt_check.png` | `ep10_v046-ep10_v050` | ミナが第1話レシートを出してお客様確認を始める。 |
...
| 13 | 剥がさない方がいい | `assets/scenes/planned/ep10_vc13_do_not_peel_tag.png` | `ep10_v061-ep10_v065` | ミナが首元パッチを見て剥がさない方がいいと言う。青年が従う。 |
...
| 16 | 一時保留受理 | `assets/scenes/planned/ep10_vc16_temporary_hold.png` | `ep10_v076-ep10_v080` | ミナが保留を選び、第十三レジが一時保留を受理。次回棚卸し時に再確認。 |
