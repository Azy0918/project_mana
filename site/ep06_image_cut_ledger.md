...
| 02 | 賞味期限がない | `assets/scenes/planned/ep06_vc02_no_expiration_date.png` | `ep06_v006-ep06_v010` | タクミが白い紙袋を持ち、賞味期限がないことに困惑。ミナは昔のパンかと淡々。 |
...
| 09 | 試食案 | `assets/scenes/planned/ep06_vc09_taste_test_bad_idea.png` | `ep06_v041-ep06_v045` | ミナが試食案を出し、タクミが実験台にしないでと引く。パンと端末。 |
...
| 18 | 保留箱へ | `assets/scenes/planned/ep06_vc18_pending_box_bread.png` | `ep06_v086-ep06_v090` | ミナが保留箱を棚に置き、パンを朝まで保管する。 |
