...
SEED_KNOWN_COMBOS: list[dict[str, Any]] = [
    ...
    {
        "combo_name": "グスタフ 落城の計 拘束ループ",
        "format": "AD",
        "archetype": "グスタフループ",
        "core_cards": "グスタフ・アルブサール;龍脈術 落城の計",
        "starter_cards": "堕呪 ウキドゥ;エナジー・ライト",
        "support_cards": "終末の時計 ザ・クロック",
        "payoff_cards": "グスタフ・アルブサール",
        "required_zones": "墓地;手札",
        "required_conditions": "グスタフ着地後、攻撃時の呪文回収でループ開始",
        "main_sequence": "グスタフの攻撃時回収でバウンス呪文を使い回し、相手の盤面と行動を継続的に縛って詰める",
        "win_condition": "行動拘束からの打点または相手投了圧",
        "strengths": "対応力が高く受けも硬い",
        "weaknesses": "着地前の速攻、ハンデス",
        "counter_cards_or_tags": "速攻;ハンデス;呪文メタ",
        "related_tags": "ループ;バウンス;コントロール",
        "pattern_type": "ループ",
        "notes": "route想定: lock_confirmed_win / opponent_deckout_win",
    },
    {
    ...
    },
    {
        ...
        "required_zones": "手札",
        "required_conditions": "相手のハンデスまたは自分の手札破棄誘発",
        "main_sequence": "バクアドルガンの攻撃時ディスカードでバイケンを踏み倒し、バウンスと打点でカウンターする",
        "win_condition": "カウンター展開からの打点",
        "strengths": "ハンデス耐性、攻守一体",
        "weaknesses": "踏み倒しメタ、除去耐性のなさ",
    ...
    {
        "combo_name": "ヘブンズ・フォース 絶十 早出しメタビート",
        "format": "ND",
        "archetype": "白単サバキZ",
        "core_cards": "ヘブンズ・フォース;煌メク聖戦 絶十",
        "starter_cards": "奇石 ミクセル/ジャミング・チャフ",
        "support_cards": "煌世主 サッヴァーク†",
        "payoff_cards": "煌メク聖戦 絶十",
        "required_zones": "手札;シールド",
        "required_conditions": "2ターン目ヘブンズ・フォース",
        "main_sequence": "2ターン目にヘブンズ・フォースで絶十を早出しし、表向きシールド追加と裁きの紋章で継戦しながら制圧する",
        "win_condition": "早出しアドバンテージからの制圧",
